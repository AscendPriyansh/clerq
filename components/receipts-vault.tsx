...
export type ReceiptRow = { id: string; source: string; vendorName: string | null; date: string; amount: string; taxAmount: string; currency: string; category: string; status: string; confidenceScore: number; createdAt: string; notes: string | null };
